...
class feature_fuse(nn.Module):
    def __init__(self, in_c, out_c):
        ...
        self.conv11 = nn.Conv2d(in_c, out_c, kernel_size=1,
                      padding=0, bias=False)

        self.conv33 = nn.Conv2d(in_c, out_c, kernel_size=3,
                      padding=1, bias=False)

        self.conv33_di = nn.Conv2d(in_c, out_c, kernel_size=3,
...
class FRNet(nn.Module):
    def __init__(self,  num_classes=1,num_channels=1, feature_scale=2,  dropout=0.2, fuse = True, out_ave=True):
        ...
        # self.fuse2 = feature_fuse(filters[0]*3,num_classes)
